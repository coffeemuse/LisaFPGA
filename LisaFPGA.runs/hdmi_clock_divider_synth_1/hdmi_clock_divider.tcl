...
OPTRACE "hdmi_clock_divider_synth_1" START { ROLLUP_AUTO }
...
synth_design -top hdmi_clock_divider -part xc7a100tcsg324-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix hdmi_clock_divider_ hdmi_clock_divider.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_clock_divider_stub.v
 lappend ipCachedFiles hdmi_clock_divider_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_clock_divider_stub.vhdl
 lappend ipCachedFiles hdmi_clock_divider_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_clock_divider_sim_netlist.v
 lappend ipCachedFiles hdmi_clock_divider_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_clock_divider_sim_netlist.vhdl
 lappend ipCachedFiles hdmi_clock_divider_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp hdmi_clock_divider.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips hdmi_clock_divider]
 }
...
rename_ref -prefix_all hdmi_clock_divider_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef hdmi_clock_divider.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file hdmi_clock_divider_utilization_synth.rpt -pb hdmi_clock_divider_utilization_synth.pb"  } 
...
OPTRACE "hdmi_clock_divider_synth_1" END { }
