...
HD_PWD='/home/alexthecat123/LisaFPGA/LisaFPGA.runs/hdmi_clock_divider_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_clock_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_clock_divider.tcl
