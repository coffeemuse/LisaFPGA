...
HD_PWD='/home/alexthecat123/LisaFPGA/LisaFPGA.runs/dotck_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dotck_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dotck_mmcm.tcl
